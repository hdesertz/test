 ...
 * Generated for Laravel 5.6.16 on 2018-04-20 01:59:19.
 *
...
namespace App\Facades { 
    ...
    class LogHelperFacade {
        ...
        {
            return \App\Lib\Util\LogHelper::get_writer();
        }
         ...
         * @static 
         */ 
        public static function log($file_name, $object, $add_time = true)
        {
            return \App\Lib\Util\LogHelper::log($file_name, $object, $add_time);
        }
...
namespace  { 
    ...
    class LogHelper extends \App\Facades\LogHelperFacade {}
